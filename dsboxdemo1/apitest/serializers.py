...
from apitest.models import  Administrators, Appconfig, Clientdetails, Subscriptiondetails, Businessdetails, Businesses, Developers, Estimatedetails, Plydetails, Transactiondetails, Userdetails
