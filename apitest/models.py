...
class Administrators(models.Model):
          ...
          adminpassword = models.CharField(db_column='AdminPassword', max_length=500)  # Field name made lowercase.
          adminemail = models.CharField(max_length=50, blank=True, null=True)
          firebaseid = models.CharField(db_column='FirebaseID', max_length=500)  # Field name made lowercase.
          fcmtoken = models.CharField(db_column='FCMToken', max_length=500)  # Field name made lowercase.
          deviceinfo = models.CharField(db_column='DeviceInfo', max_length=500)  # Field name made lowercase.
...
class Appconfig(models.Model):
          ...
          configvalue = models.CharField(db_column='ConfigValue', max_length=500, blank=True,
...
class Businessdetails(models.Model):
          ...
          pincode = models.CharField(db_column='Pincode', max_length=6, blank=True,
                                     null=True)  # Field name made lowercase.
          contactno = models.CharField(db_column='ContactNo', max_length=50, blank=True,
                                       null=True)  # Field name made lowercase.
          email = models.CharField(db_column='Email', max_length=100, blank=True,
                                   null=True)  # Field name made lowercase.
          geolocation = models.TextField(db_column='GeoLocation', blank=True, null=True)  # Field name made lowercase.
          marginlength = models.FloatField(db_column='MarginLength', blank=True,
                                           null=True)  # Field name made lowercase.
          marginwidth = models.FloatField(db_column='MarginWidth', blank=True, null=True)  # Field name made lowercase.
          burstingfactor = models.FloatField(db_column='BurstingFactor', blank=True,
                                             null=True)  # Field name made lowercase.
          ...
          estimatenote = models.TextField(db_column='EstimateNote', blank=True, null=True)  # Field name made lowercase.
          ...
          status = models.CharField(db_column='Status', max_length=10, blank=True,
                                    null=True)  # Field name made lowercase.
...
class Businesses(models.Model):
          ...
          authkey = models.CharField(db_column='AuthKey', max_length=100, blank=True,
                                     null=True)  # Field name made lowercase.
          serialkey = models.TextField(db_column='SerialKey', blank=True, null=True)  # Field name made lowercase.
          businessname = models.CharField(db_column='BusinessName', max_length=100, blank=True,
                                          null=True)  # Field name made lowercase.
          proprietorname = models.CharField(db_column='ProprietorName', max_length=100, blank=True,
                                            null=True)  # Field name made lowercase.
          mobileno = models.CharField(db_column='MobileNo', max_length=10, blank=True,
                                      null=True)  # Field name made lowercase.
          address = models.TextField(db_column='Address', db_collation='utf8mb4_0900_ai_ci', blank=True,
                                     null=True)  # Field name made lowercase.
          businesstype = models.CharField(db_column='BusinessType', max_length=20, blank=True,
                                          null=True)  # Field name made lowercase.
          ...
          remark = models.TextField(db_column='Remark', db_collation='utf8mb4_0900_ai_ci', blank=True,
                                    null=True)  # Field name made lowercase.
          status = models.CharField(db_column='Status', max_length=20, blank=True,
                                    null=True)  # Field name made lowercase.
...
class Clientdetails(models.Model):
          ...
          mobileno = models.CharField(db_column='MobileNo', max_length=10)  # Field name made lowercase.
          address = models.CharField(db_column='Address', max_length=500, blank=True,
                                     null=True)  # Field name made lowercase.
...
class Developers(models.Model):
          ...
          mobileno = models.CharField(db_column='MobileNo', max_length=10)  # Field name made lowercase.
          userrole = models.CharField(db_column='UserRole', max_length=10)  # Field name made lowercase.
...
class Estimatedetails(models.Model):
          ...
          boxname = models.TextField(db_column='BoxName', db_collation='utf8mb4_unicode_ci', blank=True,
                                     null=True)  # Field name made lowercase.
          length_mm_field = models.FloatField(
                    db_column='Length(mm)')  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          width_mm_field = models.FloatField(
                    db_column='Width(mm)')  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          height_mm_field = models.FloatField(
                    db_column='Height(mm)')  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          length_cm_field = models.FloatField(db_column='Length(cm)', blank=True,
                                              null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          width_cm_field = models.FloatField(db_column='Width(cm)', blank=True,
                                             null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          height_cm_field = models.FloatField(db_column='Height(cm)', blank=True,
                                              null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          length_inch_field = models.FloatField(db_column='Length(inch)', blank=True,
                                                null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          width_inch_field = models.FloatField(db_column='Width(inch)', blank=True,
                                               null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          height_inch_field = models.FloatField(db_column='Height(inch)', blank=True,
                                                null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
          ...
          comment = models.CharField(db_column='Comment', max_length=500, blank=True,
                                     null=True)  # Field name made lowercase.
...
class Plydetails(models.Model):
          ...
          plyname = models.CharField(db_column='PlyName', max_length=50)  # Field name made lowercase.
...
class Subscriptiondetails(models.Model):
          subscriptionid = models.BigIntegerField(db_column='SubscriptionID',
                                                  primary_key=True)  # Field name made lowercase.
          subscription = models.CharField(db_column='Subscription', max_length=50)  # Field name made lowercase.
...
class Transactiondetails(models.Model):
          ...
          duration = models.IntegerField(db_column='Duration')  # Field name made lowercase.
          amount = models.FloatField(db_column='Amount')  # Field name made lowercase.
          perticulars = models.CharField(db_column='Perticulars', max_length=500, blank=True,
                                         null=True)  # Field name made lowercase.
          status = models.CharField(db_column='Status', max_length=500, blank=True,
                                    null=True)  # Field name made lowercase.
...
class Userdetails(models.Model):
          ...
          mobileno = models.CharField(db_column='MobileNo', max_length=10)  # Field name made lowercase.
          userrole = models.CharField(db_column='UserRole', max_length=50)  # Field name made lowercase.
          useraccess = models.IntegerField(db_column='UserAccess')  # Field name made lowercase.
          androidid = models.CharField(db_column='AndroidID', max_length=100, blank=True,
                                       null=True)  # Field name made lowercase.
          deviceinfo = models.CharField(db_column='DeviceInfo', max_length=500, blank=True,
                                        null=True)  # Field name made lowercase.
          status = models.CharField(db_column='Status', max_length=10, blank=True,
                                    null=True)  # Field name made lowercase.
